...
export const APPLIANCE_REPAIR_INDUSTRY: IndustryDef = {
  ...
  keywords: ['appliance repair', 'appliance fix', 'refrigerator repair', 'washer repair', 'dryer repair', 'appliance tech', 'appliance sales', 'appliance installation', 'trash compactor', 'kitchenaid', 'ice maker', 'sub zero', 'bosch appliance', 'samsung appliance', 'lg appliance', 'whirlpool', 'appliances', 'appliance store'],
