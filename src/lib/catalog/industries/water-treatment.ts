...
export const WATER_TREATMENT_SERVICES: ServiceDef[] = [
  ...
  wt('Water Quality Testing', 'Testing', ['fresh-clean', 'home-guardian', 'modern-office', 'minimalist-zen'], ['trust-report', 'trust-builder', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Water testing panels covering lead, bacteria, nitrates, and hardness.' }, ['water testing', 'water quality test', 'water test', 'water analysis']),
  wt('Acid Neutralizer & pH Correction', 'Filtration', ['fresh-clean', 'minimalist-zen', 'modern-office', 'classic-warm'], ['trust-report', 'process-steps', 'trust-builder', 'conversion-focus'], { image: IMG, description: 'Low-pH water corrected before it eats the copper.' }, ['acid neutralizer', 'ph correction', 'acidic water', 'neutralizer tank']),
  wt('Well Water Treatment Systems', 'Filtration', ['fresh-clean', 'minimalist-zen', 'modern-office', 'classic-warm'], ['trust-report', 'process-steps', 'trust-builder', 'conversion-focus'], { image: IMG, description: 'Multi-stage treatment built around a well water test.' }, ['well water treatment', 'well water filter', 'well water system']),
]
