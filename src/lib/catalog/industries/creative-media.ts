...
export const PHOTOGRAPHY_VIDEO_SERVICES: ServiceDef[] = [
  ...
  ph('Portrait & Family Photography', 'Events', 'photography-video', ['media-creative', 'luxury-gallery', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'storyteller'], { image: IMG, description: 'Sessions for families, seniors, and headshots, indoors or on location.' }, ['portrait photography', 'family photos', 'headshots', 'senior photos']),
  ph('Wedding Photography', 'Events', 'photography-video', ['media-creative', 'luxury-gallery', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'storyteller'], { image: IMG, description: 'Full-day wedding coverage with a second shooter and an album.' }, ['wedding photography', 'wedding photographer', 'engagement photos']),
  ph('Photo Editing & Restoration', 'Commercial', 'photography-video', ['media-creative', 'luxury-gallery', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'storyteller'], { image: IMG, description: 'Retouching, colour work, and restoration of damaged prints.' }, ['photo editing', 'photo restoration', 'retouching', 'old photo repair']),
]
...
export const DRONE_SERVICES_SERVICES: ServiceDef[] = [
  ...
  ph('Mapping & Orthomosaic Surveys', 'Commercial', 'drone-services', ['media-creative', 'luxury-gallery', 'modern-office', 'commercial-pro'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'trust-report'], { image: IMG, description: 'Georeferenced maps and volume calculations from the air.' }, ['drone mapping', 'orthomosaic', 'drone survey', 'volumetric survey']),
  ph('Agricultural & Land Drone Services', 'Commercial', 'drone-services', ['media-creative', 'luxury-gallery', 'modern-office', 'commercial-pro'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'trust-report'], { image: IMG, description: 'Crop health imaging and acreage documentation for growers.' }, ['agricultural drone', 'crop imaging', 'farm drone', 'ndvi imaging']),
  ph('Event & Wedding Aerial Coverage', 'Aerial', 'drone-services', ['media-creative', 'luxury-gallery', 'modern-office', 'commercial-pro'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'trust-report'], { image: IMG, description: 'Aerial coverage layered into event and wedding films.' }, ['event drone', 'wedding drone', 'aerial event coverage']),
  ph('Infrastructure & Tower Inspection', 'Inspection', 'drone-services', ['media-creative', 'luxury-gallery', 'modern-office', 'commercial-pro'], ['gallery-showcase', 'portfolio-first', 'visual-impact', 'trust-report'], { image: IMG, description: 'Close-visual inspection of towers, bridges, and solar arrays.' }, ['tower inspection', 'infrastructure inspection', 'bridge inspection drone', 'solar inspection']),
]
...
export const HOME_STAGING_SERVICES: ServiceDef[] = [
  ...
  ph('Vacant Home Staging', 'Staging', 'home-staging', ['luxury-gallery', 'luxury-minimal', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'before-after', 'trust-builder'], { image: IMG, description: 'Full furniture and art package installed in an empty listing.' }, ['vacant staging', 'empty house staging', 'furniture rental staging']),
  ph('Staging Consultation & Report', 'Staging', 'home-staging', ['luxury-gallery', 'luxury-minimal', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'before-after', 'trust-builder'], { image: IMG, description: 'A walkthrough with a room-by-room written plan the owner can execute.' }, ['staging consultation', 'staging report', 'home staging advice']),
  ph('Luxury Property Staging', 'Staging', 'home-staging', ['luxury-gallery', 'luxury-minimal', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'before-after', 'trust-builder'], { image: IMG, description: 'Designer inventory and art for high-end listings and model homes.' }, ['luxury staging', 'high end staging', 'model home staging']),
  ph('Furniture Rental for Staging', 'Staging', 'home-staging', ['luxury-gallery', 'luxury-minimal', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'before-after', 'trust-builder'], { image: IMG, description: 'Month-to-month furniture and decor rental with delivery and pickup.' }, ['staging furniture rental', 'furniture rental', 'decor rental']),
  ph('De-Cluttering & Redesign', 'Staging', 'home-staging', ['luxury-gallery', 'luxury-minimal', 'modern-office', 'elegant-dressing'], ['gallery-showcase', 'portfolio-first', 'before-after', 'trust-builder'], { image: IMG, description: 'Editing, redesign, and rearrangement using what the owner already has.' }, ['decluttering', 'redesign', 'room redesign', 'home refresh']),
]
