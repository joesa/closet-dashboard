...
export const INSULATION_SERVICES: ServiceDef[] = [
  ...
  ins('Radiant Barrier Installation', 'Specialty', ['warm-handyman', 'functional-utility', 'classic-warm', 'modern-office'], ['process-steps', 'trust-builder', 'before-after', 'conversion-focus'], { image: IMG, description: 'Attic radiant barrier installed to cut summer heat gain.' }, ['radiant barrier', 'attic radiant barrier', 'reflective insulation']),
]
