...
export const COUNTERTOPS_SERVICES: ServiceDef[] = [
  ...
  ct('Countertop Templating & Fabrication', 'Stone', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'Digital templating, fabrication, and edge profiling before install.' }, ['countertop templating', 'countertop fabrication', 'stone fabrication', 'edge profile']),
]
