...
export const WATERPROOFING_SERVICES: ServiceDef[] = [
  ...
  wp('French Drain Installation', 'Drainage', 'waterproofing', ['stone-masonry', 'functional-utility', 'commercial-pro', 'classic-warm'], ['trust-builder', 'process-steps', 'before-after', 'trust-report'], { image: IMG, description: 'Perimeter and yard french drains dug, piped, and daylighted.' }, ['french drain', 'perimeter drain', 'yard drainage', 'drain tile']),
  wp('Vapor Barrier & Moisture Control', 'Crawl Space', 'waterproofing', ['stone-masonry', 'functional-utility', 'commercial-pro', 'classic-warm'], ['trust-builder', 'process-steps', 'before-after', 'trust-report'], { image: IMG, description: 'Vapor barriers, drainage matting, and dehumidification under the house.' }, ['vapor barrier', 'crawl space moisture', 'under house moisture', 'dehumidifier crawl space']),
  wp('Egress Window Installation', 'Basement', 'waterproofing', ['stone-masonry', 'functional-utility', 'commercial-pro', 'classic-warm'], ['trust-builder', 'process-steps', 'before-after', 'trust-report'], { image: IMG, description: 'Code-size egress windows cut in, with well and ladder.' }, ['egress window', 'basement window install', 'window well install']),
]
...
export const FOUNDATION_REPAIR_SERVICES: ServiceDef[] = [
  ...
  wp('Slab Foundation Repair', 'Cracks', 'foundation-repair', ['stone-masonry', 'functional-utility', 'brutalist', 'commercial-pro'], ['trust-report', 'process-steps', 'trust-builder', 'before-after'], { image: IMG, description: 'Slab cracks, heave, and settlement repaired with piers or grouting.' }, ['slab repair', 'slab foundation repair', 'concrete slab crack', 'slab heave']),
  wp('Helical & Push Pier Installation', 'Settlement', 'foundation-repair', ['stone-masonry', 'functional-utility', 'brutalist', 'commercial-pro'], ['trust-report', 'process-steps', 'trust-builder', 'before-after'], { image: IMG, description: 'Steel piers driven to load-bearing strata and the structure re-supported.' }, ['helical piers', 'push piers', 'pier installation', 'underpinning']),
  wp('Crawl Space Support & Jacking', 'Settlement', 'foundation-repair', ['stone-masonry', 'functional-utility', 'brutalist', 'commercial-pro'], ['trust-report', 'process-steps', 'trust-builder', 'before-after'], { image: IMG, description: 'Failing girders and posts replaced, and sagging floors jacked level.' }, ['crawl space jacks', 'floor leveling', 'girder replacement', 'sagging floor repair']),
  wp('Retaining & Basement Wall Repair', 'Walls', 'foundation-repair', ['stone-masonry', 'functional-utility', 'brutalist', 'commercial-pro'], ['trust-report', 'process-steps', 'trust-builder', 'before-after'], { image: IMG, description: 'Bowed and cracked walls braced, tied back, and sealed.' }, ['bowed wall repair', 'basement wall repair', 'retaining wall repair', 'wall bracing']),
]
