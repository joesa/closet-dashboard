...
export const GENERATOR_SERVICES_SERVICES: ServiceDef[] = [
  ...
  gen('Load Calculation & Sizing', 'Installation', ['functional-utility', 'modern-office', 'commercial-pro', 'swift-mobile'], ['emergency-first', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: 'Load study that sizes the unit to what actually has to run.' }, ['generator sizing', 'load calculation', 'generator load study']),
  gen('Fuel System & Propane Hookup', 'Installation', ['functional-utility', 'modern-office', 'commercial-pro', 'swift-mobile'], ['emergency-first', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: 'Gas and propane lines run, sized, and pressure tested for the set.' }, ['generator fuel line', 'propane hookup generator', 'gas line generator']),
]
