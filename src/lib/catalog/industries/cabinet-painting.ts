...
export const CABINET_PAINTING_SERVICES: ServiceDef[] = [
  ...
  cab('Cabinet Door Replacement', 'Refacing', ['bold-remodel', 'artisan-wood', 'classic-warm', 'luxury-minimal'], ['before-after', 'gallery-showcase', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'New doors and drawer fronts on existing boxes, in your finish.' }, ['cabinet door replacement', 'new cabinet doors', 'drawer front replacement']),
  cab('Interior Cabinet Organizers', 'Installation', ['bold-remodel', 'artisan-wood', 'classic-warm', 'luxury-minimal'], ['before-after', 'gallery-showcase', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'Roll-out trays, dividers, and lazy susans fitted into existing cabinets.' }, ['cabinet organizers', 'roll out shelves', 'pull out shelves', 'cabinet inserts']),
  cab('Built-In & Trim Painting', 'Painting', ['bold-remodel', 'artisan-wood', 'classic-warm', 'luxury-minimal'], ['before-after', 'gallery-showcase', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'Built-ins, mantels, and trim sprayed to a furniture-grade finish.' }, ['built in painting', 'trim painting', 'mantel painting', 'millwork painting']),
]
