...
export const EVENT_RENTALS_SERVICES: ServiceDef[] = [
  ...
  ev('Dance Floor & Staging Rental', 'AV', 'event-rentals', ['event-festive', 'playful-kids', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Portable dance floors and stage decks delivered and set.' }, ['dance floor rental', 'stage rental', 'portable stage', 'staging rental']),
  ev('China, Glassware & Catering Rental', 'Furniture', 'event-rentals', ['event-festive', 'playful-kids', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Plates, glassware, flatware, and chafing gear by the count.' }, ['china rental', 'glassware rental', 'catering equipment rental', 'flatware rental']),
  ev('Heating, Cooling & Power Rental', 'AV', 'event-rentals', ['event-festive', 'playful-kids', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Patio heaters, fans, and generators for outdoor events.' }, ['heater rental', 'generator rental event', 'event cooling', 'patio heater rental']),
  ev('Wedding Decor & Arch Rental', 'Entertainment', 'event-rentals', ['event-festive', 'playful-kids', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Arches, drapery, and decor packages for the ceremony.' }, ['wedding decor rental', 'arch rental', 'drapery rental', 'backdrop rental']),
]
...
export const DJ_ENTERTAINMENT_SERVICES: ServiceDef[] = [
  ...
  ev('Ceremony Sound & Microphones', 'Weddings', 'dj-entertainment', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Ceremony PA, lapel and handheld mics, and a second sound zone.' }, ['ceremony sound', 'wedding microphone', 'ceremony pa', 'wedding audio']),
  ev('Uplighting & Dance Floor Lighting', 'Events', 'dj-entertainment', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Room uplighting, monogram, and dance-floor lighting design.' }, ['uplighting', 'dance floor lighting', 'event lighting', 'monogram light']),
  ev('School Dance & Prom DJ', 'Events', 'dj-entertainment', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Clean-edit sets for school dances, with a school-approved playlist.' }, ['school dance dj', 'prom dj', 'homecoming dj']),
  ev('MC & Emcee Service', 'Entertainment', 'dj-entertainment', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'A host to run introductions, timeline, and announcements.' }, ['mc service', 'emcee', 'wedding mc', 'event host']),
  ev('Photo Booth & Party Add-Ons', 'Entertainment', 'dj-entertainment', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Photo booth, cold sparks, and dancing-on-a-cloud add-ons.' }, ['photo booth', 'cold sparks', 'dancing on a cloud', 'party add ons']),
]
...
export const BOUNCE_HOUSE_SERVICES: ServiceDef[] = [
  ...
  ev('Interactive Games & Sports Inflatables', 'Entertainment', 'bounce-house', ['playful-kids', 'event-festive', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'trust-builder'], { image: IMG, description: 'Joust, basketball, and interactive inflatable games.' }, ['interactive inflatables', 'inflatable games', 'sports inflatables', 'joust rental']),
  ev('Toddler & Soft Play Rental', 'Inflatables', 'bounce-house', ['playful-kids', 'event-festive', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'trust-builder'], { image: IMG, description: 'Soft play sets and small units sized for under-fives.' }, ['soft play rental', 'toddler bounce house', 'baby play rental']),
  ev('Concession & Party Extras', 'Entertainment', 'bounce-house', ['playful-kids', 'event-festive', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'trust-builder'], { image: IMG, description: 'Popcorn, cotton candy, and snow cone machines with supplies.' }, ['concession rental', 'popcorn machine rental', 'cotton candy machine', 'snow cone rental']),
  ev('Event Staffing & Attendants', 'Entertainment', 'bounce-house', ['playful-kids', 'event-festive', 'classic-warm', 'gourmet-warm'], ['event-booking', 'gallery-showcase', 'compact-quote', 'trust-builder'], { image: IMG, description: 'Trained attendants to run and supervise the units.' }, ['event staffing', 'inflatable attendant', 'party staffing', 'ride operator']),
]
...
export const FOOD_TRUCK_SERVICES: ServiceDef[] = [
  ...
  ev('Wedding & Private Event Catering', 'Catering', 'food-truck', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'The truck on site for your event, with a set menu and headcount.' }, ['food truck wedding', 'private event food truck', 'food truck catering']),
  ev('School & Community Events', 'Events', 'food-truck', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Fundraiser nights, sports tournaments, and community festivals.' }, ['school event food truck', 'fundraiser food truck', 'community event vendor']),
  ev('Brewery & Bar Residency', 'Events', 'food-truck', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'A standing weekly night parked at a taproom or bar.' }, ['brewery food truck', 'taproom food truck', 'food truck residency']),
  ev('Catering Drop-Off & Trays', 'Catering', 'food-truck', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'Pans and trays delivered without the truck, for indoor events.' }, ['drop off catering', 'catering trays', 'office catering delivery']),
  ev('Truck Rental & Branding', 'Corporate', 'food-truck', ['sleek-entertainment', 'media-theater', 'creative-craft', 'playful-kids'], ['event-booking', 'conversion-focus', 'gallery-showcase', 'trust-builder'], { image: IMG, description: 'The truck wrapped and staffed as a branded activation.' }, ['food truck rental', 'branded food truck', 'marketing activation']),
]
