...
export const DECK_MAINTENANCE_SERVICES: ServiceDef[] = [
  ...
  dk('Deck Inspection & Safety Check', 'Restoration', ['artisan-wood', 'rustic-pantry', 'classic-warm', 'coastal-climate'], ['before-after', 'seasonal-cta', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'Ledger, joists, and rails checked against code before the season.' }, ['deck inspection', 'deck safety', 'ledger inspection', 'deck code check']),
  dk('Composite Deck Cleaning', 'Cleaning', ['artisan-wood', 'rustic-pantry', 'classic-warm', 'coastal-climate'], ['before-after', 'seasonal-cta', 'portfolio-first', 'conversion-focus'], { image: IMG, description: 'Composite decking cleaned without the pressure that scars it.' }, ['composite deck cleaning', 'trex cleaning', 'composite decking care']),
]
