...
export const PARKING_LOT_SERVICES: ServiceDef[] = [
  ...
  mk('Asphalt Paving & Overlay', 'Sealing', 'parking-lot', ['commercial-pro', 'brutalist', 'functional-utility', 'stone-masonry'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'New asphalt and overlays laid, rolled, and jointed.' }, ['asphalt paving', 'paving contractor', 'asphalt overlay', 'blacktop paving', 'asphalt companies']),
  mk('Asphalt Resurfacing & Milling', 'Repair', 'parking-lot', ['commercial-pro', 'brutalist', 'functional-utility', 'stone-masonry'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Failed surfaces milled and resurfaced to the original grade.' }, ['asphalt resurfacing', 'milling', 'asphalt replacement', 'repave']),
  mk('Parking Lot Drainage & Grading', 'Repair', 'parking-lot', ['commercial-pro', 'brutalist', 'functional-utility', 'stone-masonry'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Ponding corrected with regrading and inlet work.' }, ['parking lot drainage', 'lot grading', 'ponding water lot', 'catch basin repair']),
  mk('ADA Compliance & Accessible Striping', 'Accessories', 'parking-lot', ['commercial-pro', 'brutalist', 'functional-utility', 'stone-masonry'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Accessible stalls, aisles, and signage laid out to ADA measurement.' }, ['ada striping', 'accessible parking', 'handicap striping', 'ada compliance parking']),
]
...
export const ELEVATOR_SERVICES_SERVICES: ServiceDef[] = [
  ...
  mk('Emergency Elevator Service', 'Repair', 'elevator-services', ['commercial-pro', 'modern-office', 'functional-utility', 'classic-warm'], ['trust-report', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: '24-hour entrapment and shutdown response.' }, ['elevator emergency', 'entrapment response', 'elevator stuck', '24 hour elevator']),
  mk('Residential & Home Elevator Installation', 'Modernization', 'elevator-services', ['commercial-pro', 'modern-office', 'functional-utility', 'classic-warm'], ['trust-report', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: 'Home elevators and shaftway work for private residences.' }, ['home elevator', 'residential elevator', 'private elevator install']),
  mk('Wheelchair & Platform Lift Service', 'Maintenance', 'elevator-services', ['commercial-pro', 'modern-office', 'functional-utility', 'classic-warm'], ['trust-report', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: 'Platform and stair lifts serviced and certified.' }, ['platform lift service', 'wheelchair lift repair', 'stair lift service']),
  mk('Escalator & Moving Walk Service', 'Maintenance', 'elevator-services', ['commercial-pro', 'modern-office', 'functional-utility', 'classic-warm'], ['trust-report', 'trust-builder', 'compact-quote', 'process-steps'], { image: IMG, description: 'Escalators and moving walks inspected, cleaned, and repaired.' }, ['escalator service', 'escalator repair', 'moving walk maintenance']),
]
