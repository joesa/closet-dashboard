...
export const EPOXY_FLOORING_SERVICES: ServiceDef[] = [
  ...
  ep('Basement & Interior Floor Coating', 'Residential', ['garage-industrial', 'bold-remodel', 'brutalist', 'commercial-pro'], ['before-after', 'gallery-showcase', 'visual-impact', 'conversion-focus'], { image: IMG, description: 'Basement and utility floors coated to shed moisture and clean easily.' }, ['basement floor coating', 'interior epoxy', 'utility room floor']),
  ep('Concrete Grinding & Surface Prep', 'Specialty', ['garage-industrial', 'bold-remodel', 'brutalist', 'commercial-pro'], ['before-after', 'gallery-showcase', 'visual-impact', 'conversion-focus'], { image: IMG, description: 'Diamond grinding and shot blasting so the coating actually bonds.' }, ['concrete grinding', 'surface prep', 'shot blasting', 'floor prep']),
  ep('Anti-Slip & Safety Coatings', 'Specialty', ['garage-industrial', 'bold-remodel', 'brutalist', 'commercial-pro'], ['before-after', 'gallery-showcase', 'visual-impact', 'conversion-focus'], { image: IMG, description: 'Broadcast aggregate and safety striping for ramps and wet areas.' }, ['anti slip coating', 'safety flooring', 'non slip floor', 'aggregate broadcast']),
]
