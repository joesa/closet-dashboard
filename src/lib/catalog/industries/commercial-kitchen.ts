...
export const COMMERCIAL_REFRIGERATION_SERVICES: ServiceDef[] = [
  ...
  cr('Refrigerant Leak Detection & Repair', 'Walk-Ins', 'commercial-refrigeration', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Leaks located and repaired with the charge documented.' }, ['refrigerant leak', 'leak detection', 'freon leak', 'refrigeration leak repair']),
  cr('Display Case & Merchandiser Service', 'Installation', 'commercial-refrigeration', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Reach-ins, display cases, and merchandisers serviced on route.' }, ['display case repair', 'merchandiser repair', 'reach in cooler repair']),
  cr('Temperature Monitoring & Alarms', 'Maintenance', 'commercial-refrigeration', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Remote temperature logging and alarms for compliance.' }, ['temperature monitoring', 'cooler alarm', 'refrigeration monitoring', 'haccp logging']),
  cr('Emergency Refrigeration Service', 'Walk-Ins', 'commercial-refrigeration', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Same-night response when a box is climbing and product is at risk.' }, ['emergency refrigeration', '24 hour refrigeration', 'cooler down', 'freezer emergency']),
]
...
export const RESTAURANT_EQUIPMENT_SERVICES: ServiceDef[] = [
  ...
  cr('Steam Table & Warmer Repair', 'Kitchen', 'restaurant-equipment', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Holding cabinets, steam tables, and warmers repaired.' }, ['steam table repair', 'food warmer repair', 'holding cabinet repair']),
  cr('Espresso & Beverage Equipment Service', 'Kitchen', 'restaurant-equipment', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Espresso machines, grinders, and dispensers serviced and calibrated.' }, ['espresso machine repair', 'coffee equipment service', 'beverage equipment repair']),
  cr('Gas Line & Equipment Installation', 'Exhaust', 'restaurant-equipment', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Gas connections, regulators, and equipment set and tested.' }, ['commercial gas line', 'equipment installation', 'gas connection restaurant']),
  cr('Preventive Maintenance Contracts', 'Kitchen', 'restaurant-equipment', ['commercial-pro', 'functional-utility', 'modern-office', 'brutalist'], ['emergency-first', 'trust-builder', 'compact-quote', 'conversion-focus'], { image: IMG, description: 'Scheduled kitchen PM so equipment fails on your calendar, not theirs.' }, ['kitchen maintenance contract', 'restaurant pm', 'equipment maintenance plan']),
]
