...
export const DRYWALL_SERVICES: ServiceDef[] = [
  ...
  dw('Popcorn Ceiling Removal', 'Texture', ['warm-handyman', 'functional-utility', 'bold-remodel', 'classic-warm'], ['before-after', 'trust-builder', 'process-steps', 'conversion-focus'], { image: IMG, description: 'Textured ceilings scraped, skimmed, and refinished smooth.' }, ['popcorn ceiling removal', 'ceiling scraping', 'texture removal', 'smooth ceiling']),
]
