...
export const DUCT_CLEANING_SERVICES: ServiceDef[] = [
  ...
  dc('Dryer Vent Repair & Rerouting', 'Dryer Vents', 'duct-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Crushed and over-long vent runs rebuilt to code.' }, ['dryer vent repair', 'dryer vent rerouting', 'dryer vent install']),
  dc('Air Filtration & Purifier Installation', 'Sanitization', 'duct-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Media cabinets, UV, and whole-house purifiers fitted to the system.' }, ['air purifier installation', 'media filter', 'uv air purifier', 'whole house filtration']),
  dc('Chimney & Exhaust Vent Cleaning', 'Ducts', 'duct-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Bath fans, kitchen exhaust, and utility vents cleared.' }, ['exhaust vent cleaning', 'bath fan cleaning', 'kitchen exhaust cleaning']),
  dc('Duct Inspection & Camera Survey', 'Ducts', 'duct-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Camera survey with before and after footage of the run.' }, ['duct inspection', 'duct camera', 'air duct inspection']),
]
...
export const TILE_GROUT_CLEANING_SERVICES: ServiceDef[] = [
  ...
  dc('Grout Repair & Regrouting', 'Restoration', 'tile-grout-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Cracked and missing grout cut out and replaced before sealing.' }, ['grout repair', 'regrouting', 'grout replacement', 'cracked grout']),
  dc('Caulking & Shower Reseal', 'Restoration', 'tile-grout-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Failed caulk removed and joints resealed with mold-resistant sealant.' }, ['caulking', 'shower caulk', 'reseal shower', 'bathroom caulking']),
  dc('Natural Stone Polishing', 'Cleaning', 'tile-grout-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Marble, travertine, and terrazzo honed and polished back.' }, ['stone polishing', 'marble polishing', 'travertine restoration', 'terrazzo polishing']),
  dc('Tile Repair & Replacement', 'Restoration', 'tile-grout-cleaning', ['fresh-clean', 'functional-utility', 'minimalist-zen', 'modern-office'], ['before-after', 'trust-builder', 'compact-quote', 'local-expert'], { image: IMG, description: 'Cracked and hollow tiles lifted and replaced to match.' }, ['tile repair', 'replace tile', 'cracked tile', 'loose tile']),
]
