...
export const FIRE_PROTECTION_SERVICES: ServiceDef[] = [
  ...
  fp('Backflow & Fire Pump Testing', 'Sprinklers', ['commercial-pro', 'home-guardian', 'functional-utility', 'modern-office'], ['trust-report', 'trust-builder', 'process-steps', 'local-expert'], { image: IMG, description: 'Annual fire pump and backflow testing with the paperwork filed.' }, ['fire pump testing', 'backflow testing', 'fire system testing']),
  fp('Kitchen Hood Suppression Service', 'Suppression', ['commercial-pro', 'home-guardian', 'functional-utility', 'modern-office'], ['trust-report', 'trust-builder', 'process-steps', 'local-expert'], { image: IMG, description: 'Restaurant hood systems inspected, tagged, and recharged.' }, ['hood suppression', 'ansul system', 'kitchen fire suppression', 'hood system inspection']),
]
