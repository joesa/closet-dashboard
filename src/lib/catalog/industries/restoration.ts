...
export const MOLD_REMEDIATION_SERVICES: ServiceDef[] = [
  ...
  rs('Attic Mold Treatment', 'Remediation', 'mold-remediation', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Attic sheathing treated and the ventilation fault that caused it corrected.' }, ['attic mold', 'attic mold removal', 'roof sheathing mold']),
  rs('HVAC & Duct Mold Remediation', 'Remediation', 'mold-remediation', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Coils, plenums, and ducts cleaned and treated.' }, ['hvac mold', 'duct mold', 'air handler mold']),
  rs('Air Quality & Spore Testing', 'Testing', 'mold-remediation', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Air and surface sampling with lab results you can act on.' }, ['air quality testing', 'spore testing', 'mold air test', 'indoor air quality']),
  rs('Content Cleaning & Contents Restoration', 'Crawl Space', 'mold-remediation', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Furniture and belongings cleaned or documented for a claim.' }, ['contents cleaning', 'content restoration', 'belongings cleaning']),
]
...
export const FIRE_RESTORATION_SERVICES: ServiceDef[] = [
  ...
  rs('Board-Up & Emergency Securing', 'Fire', 'fire-restoration', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Openings boarded, roofs tarped, and the structure secured same day.' }, ['board up', 'emergency board up', 'tarping', 'secure property']),
  rs('Soot & Smoke Residue Cleaning', 'Fire', 'fire-restoration', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Soot removed from surfaces before it etches and sets.' }, ['soot cleaning', 'smoke residue', 'soot removal', 'smoke cleaning']),
  rs('Structural Cleaning & Deodorization', 'Odor', 'fire-restoration', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Framing cleaned, sealed, and deodorized before rebuild.' }, ['structural cleaning', 'deodorization', 'seal framing', 'smoke odor removal']),
  rs('Insurance Claim Documentation', 'Contents', 'fire-restoration', ['fresh-clean', 'functional-utility', 'commercial-pro', 'home-guardian'], ['emergency-first', 'trust-report', 'trust-builder', 'process-steps'], { image: IMG, description: 'Scope, photos, and line-item estimates written for the adjuster.' }, ['insurance documentation', 'claim estimate', 'adjuster documentation', 'restoration estimate']),
]
