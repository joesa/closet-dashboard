...
export const SEPTIC_SERVICES_SERVICES: ServiceDef[] = [
  ...
  mk('Grease Trap Pumping', 'Pumping', 'septic-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Restaurant and commercial grease traps pumped on a schedule.' }, ['grease trap pumping', 'grease trap service', 'commercial grease trap']),
  mk('Septic Tank Locating & Riser Install', 'Inspection', 'septic-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Buried tanks located and risers set so the next service is simple.' }, ['septic locating', 'septic riser', 'find septic tank', 'septic lid install']),
  mk('Lift Station & Pump Service', 'Repair', 'septic-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Effluent pumps and lift stations serviced and replaced.' }, ['lift station service', 'septic pump repair', 'effluent pump', 'sewage pump']),
]
...
export const WELL_SERVICES_SERVICES: ServiceDef[] = [
  ...
  mk('Well Cleaning & Rehabilitation', 'Drilling', 'well-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Screens and casings cleaned to bring yield back on an older well.' }, ['well cleaning', 'well rehabilitation', 'well yield', 'well redevelopment']),
  mk('Pressure Tank Replacement', 'Pump', 'well-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Waterlogged pressure tanks replaced and the switch re-set.' }, ['pressure tank', 'well tank replacement', 'pressure switch', 'water tank well']),
  mk('Constant Pressure System Installation', 'Pump', 'well-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Variable-speed systems that hold pressure across the whole house.' }, ['constant pressure system', 'variable speed pump', 'well pressure system']),
  mk('Well Abandonment & Decommissioning', 'Drilling', 'well-services', ['functional-utility', 'classic-warm', 'commercial-pro', 'modern-office'], ['trust-builder', 'compact-quote', 'local-expert', 'conversion-focus'], { image: IMG, description: 'Unused wells sealed and documented to state requirement.' }, ['well abandonment', 'well decommissioning', 'seal old well', 'well capping']),
]
