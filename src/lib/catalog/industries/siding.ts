...
export const SIDING_SERVICES: ServiceDef[] = [
  ...
  sid('Stucco & EIFS Repair', 'Repair', ['window-light', 'classic-warm', 'historic-classic', 'artisan-wood'], ['before-after', 'portfolio-first', 'gallery-showcase', 'conversion-focus'], { image: IMG, description: 'Cracked stucco and EIFS patched, re-textured, and re-coated.' }, ['stucco repair', 'eifs repair', 'stucco contractor', 'synthetic stucco']),
  sid('Metal & Steel Siding', 'Installation', ['window-light', 'classic-warm', 'historic-classic', 'artisan-wood'], ['before-after', 'portfolio-first', 'gallery-showcase', 'conversion-focus'], { image: IMG, description: 'Standing seam and corrugated metal siding for homes and shops.' }, ['metal siding', 'steel siding', 'corrugated siding', 'metal siding contractor']),
]
