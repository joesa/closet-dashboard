...
export const MOBILE_NOTARY_SERVICES: ServiceDef[] = [
  ...
  ps('Real Estate Closing Signings', 'Signing', 'mobile-notary', ['swift-mobile', 'modern-office', 'commercial-pro', 'minimalist-zen'], ['emergency-first', 'compact-quote', 'service-zones', 'trust-builder'], { image: IMG, description: 'Purchase, refinance, and seller packages signed at the kitchen table.' }, ['closing signing', 'real estate signing', 'refinance signing', 'notary closing']),
  ps('Estate & Healthcare Document Notary', 'Documents', 'mobile-notary', ['swift-mobile', 'modern-office', 'commercial-pro', 'minimalist-zen'], ['emergency-first', 'compact-quote', 'service-zones', 'trust-builder'], { image: IMG, description: 'Wills, POAs, and advance directives notarised at home or bedside.' }, ['estate documents notary', 'power of attorney notary', 'will signing', 'hospital notary']),
  ps('Jail & Hospital Notary Visits', 'Legal', 'mobile-notary', ['swift-mobile', 'modern-office', 'commercial-pro', 'minimalist-zen'], ['emergency-first', 'compact-quote', 'service-zones', 'trust-builder'], { image: IMG, description: 'Notary visits to facilities that most notaries will not enter.' }, ['jail notary', 'hospital notary', 'facility notary', 'bedside notary']),
  ps('Remote Online Notarization', 'Notary', 'mobile-notary', ['swift-mobile', 'modern-office', 'commercial-pro', 'minimalist-zen'], ['emergency-first', 'compact-quote', 'service-zones', 'trust-builder'], { image: IMG, description: 'Audio-video notarization for signers in another state.' }, ['remote online notarization', 'ron notary', 'online notary', 'virtual notary']),
]
...
export const PERSONAL_TRAINING_SERVICES: ServiceDef[] = [
  ...
  ps('Strength & Conditioning Program', 'Fitness', 'personal-training', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Progressive barbell and conditioning programming, coached in person.' }, ['strength training', 'conditioning', 'weight training coach', 'barbell coaching']),
  ps('Weight Loss Coaching', 'Fitness', 'personal-training', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Training plus habit and nutrition coaching built around a weekly check-in.' }, ['weight loss coach', 'fat loss program', 'nutrition coaching', 'body transformation']),
  ps('Senior & Mobility Training', 'Fitness', 'personal-training', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Balance, mobility, and strength work for clients over sixty.' }, ['senior fitness', 'mobility training', 'balance training', 'older adult fitness']),
  ps('Post-Rehab & Injury Training', 'Fitness', 'personal-training', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Return-to-activity training that picks up where physical therapy ended.' }, ['post rehab training', 'injury recovery training', 'corrective exercise']),
  ps('Sport-Specific Athletic Training', 'Fitness', 'personal-training', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Speed, agility, and off-season programming for school and club athletes.' }, ['athletic training', 'sports performance', 'speed training', 'youth athlete training']),
]
...
export const MASSAGE_THERAPY_SERVICES: ServiceDef[] = [
  ...
  ps('Prenatal Massage', 'Modalities', 'massage-therapy', ['wellness-calm', 'minimalist-zen', 'classic-warm', 'care-comfort'], ['storyteller', 'trust-builder', 'local-expert', 'compact-quote'], { image: IMG, description: 'Pregnancy massage with proper bolstering by trimester.' }, ['prenatal massage', 'pregnancy massage', 'maternity massage']),
  ps('Myofascial & Trigger Point Release', 'Modalities', 'massage-therapy', ['wellness-calm', 'minimalist-zen', 'classic-warm', 'care-comfort'], ['storyteller', 'trust-builder', 'local-expert', 'compact-quote'], { image: IMG, description: 'Slow fascial work for chronic tension patterns.' }, ['myofascial release', 'trigger point therapy', 'fascial work']),
  ps('Hot Stone & Aromatherapy Massage', 'Modalities', 'massage-therapy', ['wellness-calm', 'minimalist-zen', 'classic-warm', 'care-comfort'], ['storyteller', 'trust-builder', 'local-expert', 'compact-quote'], { image: IMG, description: 'Heat and essential oil work layered into a full-body session.' }, ['hot stone massage', 'aromatherapy massage', 'stone therapy']),
  ps('Event & Wedding Party Massage', 'Corporate', 'massage-therapy', ['wellness-calm', 'minimalist-zen', 'classic-warm', 'care-comfort'], ['storyteller', 'trust-builder', 'local-expert', 'compact-quote'], { image: IMG, description: 'On-site massage for wedding parties, retreats, and race events.' }, ['event massage', 'wedding massage', 'race event massage', 'retreat massage']),
]
...
export const TUTORING_SERVICES: ServiceDef[] = [
  ...
  ps('Math & Science Tutoring', 'Academics', 'tutoring', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Algebra through calculus, chemistry, and physics, one student at a time.' }, ['math tutor', 'algebra tutor', 'calculus tutor', 'science tutor', 'chemistry tutor']),
  ps('Reading & Writing Support', 'Academics', 'tutoring', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Phonics, comprehension, and essay work for elementary through high school.' }, ['reading tutor', 'writing tutor', 'english tutor', 'essay help']),
  ps('Special Education & IEP Support', 'Academics', 'tutoring', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Tutoring built around an existing IEP or 504 plan, in coordination with the school.' }, ['special education tutor', 'iep support', 'learning disability tutor', 'dyslexia tutor']),
  ps('College Application & Essay Coaching', 'Test Prep', 'tutoring', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Application strategy, personal statement drafting, and deadline management.' }, ['college application help', 'college essay coach', 'admissions coaching']),
  ps('Homeschool Support & Enrichment', 'Academics', 'tutoring', ['wellness-calm', 'modern-office', 'functional-utility', 'minimalist-zen'], ['trust-builder', 'conversion-focus', 'process-steps', 'compact-quote'], { image: IMG, description: 'Subject teaching and curriculum support for homeschooling families.' }, ['homeschool tutor', 'homeschool support', 'curriculum help']),
]
