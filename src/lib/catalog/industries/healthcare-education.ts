...
export const THERAPY_REHAB_SERVICES: ServiceDef[] = [
  ...
  he('Occupational Therapy', 'Physical Therapy', 'therapy-rehab', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: IMG, description: 'Regaining daily-living skills after injury, stroke, or surgery.' }, ['occupational therapy', 'ot therapy', 'hand therapy', 'daily living skills']),
  he('Sports Injury Rehabilitation', 'Physical Therapy', 'therapy-rehab', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: IMG, description: 'Return-to-play rehab with graded loading and testing.' }, ['sports rehab', 'sports injury therapy', 'acl rehab', 'return to play']),
  he('Post-Surgical Rehabilitation', 'Physical Therapy', 'therapy-rehab', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: IMG, description: 'Protocol-driven recovery after joint replacement or repair.' }, ['post surgical rehab', 'post op therapy', 'knee replacement rehab']),
  he('Pediatric Therapy', 'Speech Therapy', 'therapy-rehab', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: IMG, description: 'Speech, motor, and sensory therapy for children, with parent coaching.' }, ['pediatric therapy', 'child speech therapy', 'pediatric ot', 'early intervention']),
  he('Substance Use Counseling', 'Mental Health', 'therapy-rehab', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: IMG, description: 'Outpatient counseling and relapse-prevention planning.' }, ['substance abuse counseling', 'addiction counseling', 'recovery counseling']),
]
...
export const EDUCATION_FORMAL_SERVICES: ServiceDef[] = [
  ...
  he('Preschool & Early Childhood', 'K-12', 'education-formal', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Licensed preschool and pre-K programs with enrollment windows.' }, ['preschool', 'pre k', 'early childhood education', 'nursery school']),
  he('Montessori & Alternative Programs', 'K-12', 'education-formal', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Montessori, Waldorf, and other alternative curricula.' }, ['montessori school', 'waldorf school', 'alternative education']),
  he('Online & Distance Degree Programs', 'Higher Education', 'education-formal', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Accredited degree programs delivered online with local support.' }, ['online degree', 'distance learning', 'online college', 'remote degree']),
  he('Continuing Education & Certificates', 'Vocational', 'education-formal', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Professional certificates, CEUs, and licensure renewal courses.' }, ['continuing education', 'professional certificate', 'ceu courses']),
  he('Adult Education & GED', 'Vocational', 'education-formal', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'GED preparation, adult literacy, and ESL classes.' }, ['ged classes', 'adult education', 'adult literacy', 'esl classes']),
]
...
export const ENRICHMENT_EDUCATION_SERVICES: ServiceDef[] = [
  ...
  he('Art & Craft Classes', 'Music', 'enrichment-education', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Studio classes in drawing, painting, pottery, and mixed media.' }, ['art classes', 'pottery classes', 'painting class', 'art school']),
  he('Dance & Movement Classes', 'Music', 'enrichment-education', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Ballet, hip-hop, and adult movement classes by term.' }, ['dance classes', 'dance school', 'ballet classes', 'hip hop class']),
  he('Coding & STEM Camps', 'Tutoring', 'enrichment-education', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'After-school and holiday camps in coding, robotics, and electronics.' }, ['coding classes', 'stem camp', 'robotics class', 'kids coding']),
  he('Martial Arts & Self-Defense', 'Music', 'enrichment-education', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Belt curriculum for children and self-defense courses for adults.' }, ['martial arts', 'karate classes', 'self defense class', 'jiu jitsu']),
  he('Test & Skill Bootcamps', 'Tutoring', 'enrichment-education', ['wellness-calm', 'modern-office', 'minimalist-zen', 'classic-warm'], ['trust-builder', 'trust-report', 'process-steps', 'standard'], { image: KIDS_IMG, description: 'Short intensive courses ahead of an exam or certification date.' }, ['bootcamp', 'exam bootcamp', 'intensive course', 'skills workshop']),
]
