...
export const BEAUTY_SALON_SERVICES: ServiceDef[] = [
  ...
  pw('Hair Coloring & Highlights', 'Hair', 'beauty-salon', ['elegant-dressing', 'playful-kids', 'sleek-entertainment', 'classic-warm'], ['gallery-showcase', 'portfolio-first', 'local-expert', 'before-after'], { image: IMG, description: 'Colour, balayage, and correction work booked by the hour.' }, ['hair color', 'balayage', 'highlights', 'color correction']),
  pw('Waxing & Hair Removal', 'Nails', 'beauty-salon', ['elegant-dressing', 'playful-kids', 'sleek-entertainment', 'classic-warm'], ['gallery-showcase', 'portfolio-first', 'local-expert', 'before-after'], { image: IMG, description: 'Face and body waxing, and laser hair removal sessions.' }, ['waxing', 'hair removal', 'brazilian wax', 'laser hair removal']),
  pw('Makeup & Bridal Styling', 'Hair', 'beauty-salon', ['elegant-dressing', 'playful-kids', 'sleek-entertainment', 'classic-warm'], ['gallery-showcase', 'portfolio-first', 'local-expert', 'before-after'], { image: IMG, description: 'Event and bridal makeup, with trials and on-location service.' }, ['bridal makeup', 'makeup artist', 'wedding hair', 'event styling']),
  pw('Lash & Brow Services', 'Nails', 'beauty-salon', ['elegant-dressing', 'playful-kids', 'sleek-entertainment', 'classic-warm'], ['gallery-showcase', 'portfolio-first', 'local-expert', 'before-after'], { image: IMG, description: 'Extensions, lifts, tints, and brow shaping.' }, ['eyelash extensions', 'lash lift', 'brow lamination', 'microblading']),
]
...
export const SPA_WELLNESS_SERVICES: ServiceDef[] = [
  ...
  pw('Facials & Skin Treatments', 'Spa', 'spa-wellness', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Cleansing, chemical peel, and hydrating facial treatments.' }, ['facial', 'skin treatment', 'chemical peel', 'facials near me', 'esthetician']),
  pw('Body Wraps & Scrubs', 'Spa', 'spa-wellness', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Exfoliating scrubs, mud wraps, and full-body treatments.' }, ['body wrap', 'body scrub', 'exfoliation treatment', 'spa body treatment']),
  pw('Couples & Group Spa Packages', 'Spa', 'spa-wellness', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Side-by-side treatments and party packages by the room.' }, ['couples massage', 'spa package', 'group spa day', 'spa party']),
  pw('Cryotherapy & Cold Plunge', 'Recovery', 'spa-wellness', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Whole-body cryo and cold plunge sessions for recovery.' }, ['cryotherapy', 'cold plunge', 'ice bath', 'cryo session']),
  pw('Float Therapy', 'Recovery', 'spa-wellness', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Sensory-reduced float tank sessions, sixty or ninety minutes.' }, ['float therapy', 'float tank', 'sensory deprivation', 'floatation']),
]
...
export const FITNESS_STUDIO_SERVICES: ServiceDef[] = [
  ...
  pw('Group Fitness & HIIT Classes', 'Gym', 'fitness-studio', ['wellness-calm', 'brutalist', 'modern-office', 'playful-kids'], ['trust-builder', 'local-expert', 'process-steps', 'gallery-showcase'], { image: IMG, description: 'Coached class formats on a weekly timetable.' }, ['group fitness', 'hiit classes', 'bootcamp class', 'spin class']),
  pw('Pilates & Barre Studio', 'Yoga', 'fitness-studio', ['wellness-calm', 'brutalist', 'modern-office', 'playful-kids'], ['trust-builder', 'local-expert', 'process-steps', 'gallery-showcase'], { image: IMG, description: 'Reformer and mat pilates and barre classes.' }, ['pilates studio', 'barre class', 'reformer pilates']),
  pw('Youth & Team Athletics', 'Martial Arts', 'fitness-studio', ['wellness-calm', 'brutalist', 'modern-office', 'playful-kids'], ['trust-builder', 'local-expert', 'process-steps', 'gallery-showcase'], { image: IMG, description: 'Youth programs and team training blocks by season.' }, ['youth fitness', 'team training', 'athletic program', 'sports team training']),
  pw('Nutrition & Body Composition Coaching', 'Training', 'fitness-studio', ['wellness-calm', 'brutalist', 'modern-office', 'playful-kids'], ['trust-builder', 'local-expert', 'process-steps', 'gallery-showcase'], { image: IMG, description: 'Assessment, targets, and check-ins alongside the training.' }, ['nutrition coaching', 'body composition', 'dietitian coaching', 'meal planning']),
]
...
export const LIFE_SERVICES_SERVICES: ServiceDef[] = [
  ...
  pw('Cremation & Memorial Services', 'Funeral', 'life-services', ['care-comfort', 'historic-classic', 'classic-warm', 'minimalist-zen'], ['storyteller', 'trust-builder', 'standard', 'compact-quote'], { image: IMG, description: 'Direct cremation, urns, and memorial gatherings.' }, ['cremation services', 'memorial service', 'direct cremation', 'urns']),
  pw('Pre-Planning & Final Arrangements', 'Funeral', 'life-services', ['care-comfort', 'historic-classic', 'classic-warm', 'minimalist-zen'], ['storyteller', 'trust-builder', 'standard', 'compact-quote'], { image: IMG, description: 'Arrangements chosen and funded in advance of need.' }, ['funeral pre planning', 'pre need', 'final arrangements']),
  pw('Estate Cleanout & Settlement Support', 'Career', 'life-services', ['care-comfort', 'historic-classic', 'classic-warm', 'minimalist-zen'], ['storyteller', 'trust-builder', 'standard', 'compact-quote'], { image: IMG, description: 'Households sorted, valued, and cleared after a death.' }, ['estate cleanout', 'estate settlement', 'after death cleanout']),
  pw('Wedding Officiant Services', 'Matchmaking', 'life-services', ['care-comfort', 'historic-classic', 'classic-warm', 'minimalist-zen'], ['storyteller', 'trust-builder', 'standard', 'compact-quote'], { image: IMG, description: 'Licensed officiants for ceremonies and vow renewals.' }, ['wedding officiant', 'officiant services', 'vow renewal', 'ceremony officiant']),
]
...
export const LAUNDRY_SERVICES_SERVICES: ServiceDef[] = [
  ...
  pw('Wash & Fold by the Pound', 'Laundromat', 'laundry-services', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Drop-off laundry washed, dried, and folded, priced by weight.' }, ['wash and fold', 'laundry by the pound', 'drop off laundry']),
  pw('Laundry Pickup & Delivery', 'Laundromat', 'laundry-services', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Scheduled door pickup and next-day return in your own bag.' }, ['laundry pickup', 'laundry delivery', 'laundry service delivery']),
  pw('Commercial & Restaurant Linen', 'Linen', 'laundry-services', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Route service for aprons, towels, tablecloths, and uniforms.' }, ['commercial laundry', 'restaurant linen', 'linen service', 'uniform laundry']),
  pw('Wedding Gown Cleaning & Preservation', 'Dry Cleaning', 'laundry-services', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Gown cleaning, boxing, and preservation after the wedding.' }, ['wedding gown cleaning', 'dress preservation', 'gown preservation']),
  pw('Rug & Comforter Cleaning', 'Dry Cleaning', 'laundry-services', ['wellness-calm', 'luxury-minimal', 'minimalist-zen', 'elegant-dressing'], ['conversion-focus', 'gallery-showcase', 'trust-builder', 'standard'], { image: IMG, description: 'Oversized items too big for a home machine, cleaned flat.' }, ['comforter cleaning', 'rug cleaning', 'duvet cleaning', 'oversized laundry']),
]
