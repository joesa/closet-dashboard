...
export const OUTDOOR_LIGHTING_SERVICES: ServiceDef[] = [
  ...
  ol('Deck & Step Lighting', 'Entertainment', ['luxury-minimal', 'pool-resort', 'classic-warm', 'coastal-climate'], ['gallery-showcase', 'visual-impact', 'portfolio-first', 'seasonal-cta'], { image: IMG, description: 'Low-voltage lighting set into stair risers, posts, and rails.' }, ['deck lighting', 'step lighting', 'stair lighting', 'railing lights']),
  ol('Lighting Repair & Rewiring', 'Landscape', ['luxury-minimal', 'pool-resort', 'classic-warm', 'coastal-climate'], ['gallery-showcase', 'visual-impact', 'portfolio-first', 'seasonal-cta'], { image: IMG, description: 'Failed transformers, corroded splices, and cut wire runs repaired.' }, ['landscape lighting repair', 'low voltage repair', 'transformer repair', 'light rewiring']),
]
