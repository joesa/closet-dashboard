...
export const SNOW_REMOVAL_SERVICES: ServiceDef[] = [
  ...
  sn('Snow Hauling & Stacking', 'Plowing', ['winter-ready', 'functional-utility', 'commercial-pro', 'swift-mobile'], ['seasonal-cta', 'compact-quote', 'emergency-first', 'local-expert'], { image: IMG, description: 'Snow relocated and hauled off lots that have run out of stack space.' }, ['snow hauling', 'snow removal hauling', 'snow stacking', 'snow relocation']),
  sn('Emergency Storm Response', 'Contracts', ['winter-ready', 'functional-utility', 'commercial-pro', 'swift-mobile'], ['seasonal-cta', 'compact-quote', 'emergency-first', 'local-expert'], { image: IMG, description: 'On-call storm response for properties that must open at dawn.' }, ['emergency snow removal', 'storm response', '24 hour snow removal']),
]
