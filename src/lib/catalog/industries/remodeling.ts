...
export const BATHROOM_REMODEL_SERVICES: ServiceDef[] = [
  ...
  rm('Walk-In & Curbless Shower Conversion', 'Shower', 'bathroom-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Tubs converted to curbless showers with a properly sloped pan.' }, ['tub to shower conversion', 'walk in shower', 'curbless shower', 'shower conversion']),
  rm('Powder Room Remodel', 'Full Remodel', 'bathroom-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Half baths reworked in a week, plumbing and finishes included.' }, ['powder room remodel', 'half bath remodel', 'guest bath remodel']),
  rm('Bathroom Plumbing & Fixture Relocation', 'Fixtures', 'bathroom-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Drain and supply relocated when the layout changes.' }, ['bathroom plumbing', 'fixture relocation', 'move toilet', 'reroute plumbing']),
]
...
export const KITCHEN_REMODEL_SERVICES: ServiceDef[] = [
  ...
  rm('Kitchen Countertop Replacement', 'Cabinets', 'kitchen-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Old tops removed and new stone or quartz set and sealed.' }, ['kitchen countertop replacement', 'new countertops', 'countertop install']),
  rm('Kitchen Lighting & Electrical', 'Layout', 'kitchen-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Recessed cans, under-cabinet lighting, and added circuits.' }, ['kitchen lighting', 'under cabinet lighting', 'kitchen electrical', 'recessed lighting']),
  rm('Pantry & Storage Build-Out', 'Layout', 'kitchen-remodel', ['bold-remodel', 'luxury-minimal', 'artisan-wood', 'classic-warm'], ['gallery-showcase', 'before-after', 'portfolio-first', 'storyteller'], { image: IMG, description: 'Walk-in and cabinet pantries built out with real shelving.' }, ['pantry build out', 'pantry remodel', 'kitchen storage', 'walk in pantry']),
]
