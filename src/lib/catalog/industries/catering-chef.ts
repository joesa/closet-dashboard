...
export const CATERING_CHEF_SERVICES: ServiceDef[] = [
  ...
  cf('Wedding Catering', 'Events', ['gourmet-warm', 'rustic-pantry', 'classic-warm', 'event-festive'], ['event-booking', 'gallery-showcase', 'storyteller', 'conversion-focus'], { image: IMG, description: 'Plated and buffet wedding service with staff and rentals coordinated.' }, ['wedding catering', 'wedding caterer', 'reception catering']),
  cf('Cooking Classes & Chef Experiences', 'Specialty', ['gourmet-warm', 'rustic-pantry', 'classic-warm', 'event-festive'], ['event-booking', 'gallery-showcase', 'storyteller', 'conversion-focus'], { image: IMG, description: 'In-home classes and chef-led dinners as the entertainment.' }, ['cooking class', 'chef experience', 'private dinner party', 'chef demonstration']),
]
