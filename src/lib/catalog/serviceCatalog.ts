...
export const INDUSTRY_CONFIGS: Record<IndustrySlug, IndustryConfig> = {
  ...
  'general-contracting': { categoryLabel: 'Project', unitLabel: 'Project Size', unitAbbrev: 'sq ft', tierLabel: 'Finish Level' },
  'outdoor-structures': { categoryLabel: 'Structure', unitLabel: 'Footprint', unitAbbrev: 'sq ft', tierLabel: 'Material' },
  'furniture-repair-upholstery': { categoryLabel: 'Piece', unitLabel: 'Pieces', unitAbbrev: 'qty', tierLabel: 'Material Grade' },
  'wildlife-removal': { categoryLabel: 'Service', unitLabel: 'Property Size', unitAbbrev: 'sq ft', tierLabel: 'Package' },
  'awnings-sunrooms-patio': { categoryLabel: 'Service', unitLabel: 'Covered Area', unitAbbrev: 'sq ft', tierLabel: 'Material' },
  'recreation-play-installs': { categoryLabel: 'Service', unitLabel: 'Units', unitAbbrev: 'qty', tierLabel: 'Package' },
  'water-features-ponds': { categoryLabel: 'Feature', unitLabel: 'Water Surface', unitAbbrev: 'sq ft', tierLabel: 'Package' },
  'excavation-grading-materials': { categoryLabel: 'Service', unitLabel: 'Volume', unitAbbrev: 'yds', tierLabel: 'Scope' },
  'home-av-networking': { categoryLabel: 'Service', unitLabel: 'Rooms / Zones', unitAbbrev: 'qty', tierLabel: 'Package' },
  'accessibility-mobility': { categoryLabel: 'Service', unitLabel: 'Project Scope', unitAbbrev: 'job', tierLabel: 'Package', pricingModel: 'flat_tiered', unitMin: 1, unitMax: 1 },
  'hazmat-abatement': { categoryLabel: 'Service', unitLabel: 'Affected Area', unitAbbrev: 'sq ft', tierLabel: 'Scope' },
  'surface-refinishing': { categoryLabel: 'Surface', unitLabel: 'Surfaces', unitAbbrev: 'qty', tierLabel: 'Finish' },
  'electronics-device-repair': { categoryLabel: 'Device', unitLabel: 'Devices', unitAbbrev: 'qty', tierLabel: 'Repair Level' },
  'water-damage-restoration': { categoryLabel: 'Service', unitLabel: 'Affected Area', unitAbbrev: 'sq ft', tierLabel: 'Scope' },
  'home-organizing-design': { categoryLabel: 'Space', unitLabel: 'Rooms', unitAbbrev: 'rooms', tierLabel: 'Package' },
  'holiday-decorating': { categoryLabel: 'Service', unitLabel: 'Roofline', unitAbbrev: 'ft', tierLabel: 'Package' },
