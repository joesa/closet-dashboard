...
export const TYPE_PAIR_POOL: readonly TypePair[] = [
  ...
  { display: 'Bitter', body: 'Public Sans', why: 'slab headings with a civic-register body', moods: ['industrial', 'friendly'] },
  { display: 'Archivo', body: 'Lora', why: 'condensed signage over a readable serif', moods: ['industrial', 'technical'] },
  ...
  { display: 'Sora', body: 'Source Serif 4', why: 'engineered sans over a warm serif', moods: ['technical', 'industrial'] },
  ...
  { display: 'Domine', body: 'Assistant', why: 'sturdy serif headings, light body', moods: ['formal', 'technical'] },
  { display: 'Vollkorn', body: 'Jost', why: 'a bookish serif with a geometric companion', moods: ['friendly', 'formal'] },
  { display: 'Chivo', body: 'Literata', why: 'grotesque headings over a reading serif', moods: ['industrial', 'technical'] },
  { display: 'Rokkitt', body: 'Nunito Sans', why: 'a narrow slab over a rounded body', moods: ['friendly', 'industrial'] },
  { display: 'Cormorant Garamond', body: 'IBM Plex Sans', why: 'fine editorial display over technical body copy', moods: ['formal', 'technical'] },
  ...
  { display: 'Bodoni Moda', body: 'Figtree', why: 'high-contrast display with a contemporary reading face', moods: ['formal', 'technical'] },
  { display: 'Alegreya', body: 'Atkinson Hyperlegible', why: 'lively serif headings with highly legible body copy', moods: ['friendly', 'formal'] },
  { display: 'Prata', body: 'Noto Sans', why: 'engraved display character over a broad neutral sans', moods: ['formal', 'technical'] },
  { display: 'Young Serif', body: 'Rubik', why: 'soft display shapes over a compact practical body', moods: ['friendly', 'industrial'] },
  ...
  { display: 'Frank Ruhl Libre', body: 'Barlow', why: 'strong newspaper display over condensed utility text', moods: ['industrial', 'formal'] },
  ...
  { display: 'Bricolage Grotesque', body: 'EB Garamond', why: 'expressive grotesque display over literary reading text', moods: ['friendly', 'industrial'] },
  { display: 'Unbounded', body: 'Merriweather', why: 'wide technical display balanced by a durable text serif', moods: ['technical', 'industrial'] },
  { display: 'Cormorant Infant', body: 'DM Sans', why: 'calligraphic display details over direct body copy', moods: ['formal', 'friendly'] },
  { display: 'Cardo', body: 'Lexend', why: 'classical headings paired with generous, accessible body forms', moods: ['formal', 'friendly'] },
  ...
  { display: 'Yeseva One', body: 'PT Sans', why: 'ornamental display used sparingly over plain body text', moods: ['formal', 'friendly'] },
  { display: 'Noto Serif', body: 'IBM Plex Sans', why: 'broad-language serif headings over engineered body copy', moods: ['technical', 'formal'] },
]
...
export const SIGNATURE_POOL: readonly string[] = [
  ...
  'A full-width color-field system where each section owns one solid trade-derived hue and type carries all the decoration',
  'A night-mode cinematic frame with one spotlit photograph per scene and luminous captions',
  'Oversized soft geometric shapes carrying the services, with confident color and no hairline rules anywhere',
]
...
export const COMPOSITION_POOL: readonly string[] = [
  ...
  'stacked full-width color-field bands where each service owns its own background and type scale',
  'dark cinematic showcase with spotlighted photography and restrained luminous accents',
  'playful rounded-geometry canvas with oversized soft shapes and generous confident color',
  'utility dashboard with a fixed action rail, dense modules, and no marketing hero at all',
]
