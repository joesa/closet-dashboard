...
const INDUSTRY_BEFORE_AFTER_CATEGORY: Record<IndustrySlug, BeforeAfterCategory> = {
  ...
  'general-contracting': 'interior-space',
  'outdoor-structures': 'exterior',
  'furniture-repair-upholstery': 'fixture',
  'wildlife-removal': 'not-applicable',
  'awnings-sunrooms-patio': 'exterior',
  'recreation-play-installs': 'exterior',
  'water-features-ponds': 'exterior',
  'excavation-grading-materials': 'exterior',
  'home-av-networking': 'interior-space',
  'accessibility-mobility': 'interior-space',
  'hazmat-abatement': 'not-applicable',
  'surface-refinishing': 'fixture',
  'electronics-device-repair': 'fixture',
  'water-damage-restoration': 'interior-space',
  'home-organizing-design': 'interior-space',
