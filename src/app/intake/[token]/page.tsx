...
const EMPTY: Form = {
  ...
  streetAddress: '', addressLocality: '', addressRegion: '', postalCode: '', serviceArea: '',
  notificationEmail: '', notificationPhone: '', services: [], pricingNotes: '',
  primaryColorHex: '#6C47FF', vibe: '', tone: '', customers: '', experience: '',
  differentiators: [], primaryCta: '', desiredDomain: '', notes: '',
};
...
export default function IntakeForm({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (loading) {
    return <div className="min-h-screen grid place-items-center bg-gray-50 text-gray-500">Loading…</div>;
  }
  if (notFound) {
    return (
